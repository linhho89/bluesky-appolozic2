...
@interface ALGroupCreationViewController ()<ALContactDelegate>
...
- (void)viewDidLoad
{
    ...
    [customButton setImage:[ALUtilityClass getImageFromFramworkBundle:@"back"] forState:UIControlStateNormal];
...
#pragma mark - contact deleagte
-(void)backAndDismissViewController{
