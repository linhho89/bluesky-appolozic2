...
RCT_EXPORT_METHOD(openChat)
{
  ...
  dispatch_async(dispatch_get_main_queue(), ^{
    [chatManger launchChat:pushAssistant.topViewController orView:pushAssistant.topViewController.view];
 ...
 *
 **/
RCT_EXPORT_METHOD(openContactList)
{
  
  ALChatManager * chatManger = [[ALChatManager alloc] init];
  ALPushAssist* pushAssistant = [[ALPushAssist alloc] init];
  dispatch_async(dispatch_get_main_queue(), ^{
    [chatManger launchContactScreenFromViewController:pushAssistant.topViewController];
