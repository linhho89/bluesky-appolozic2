...
{
    [self registerUserAndLaunchChat:nil andFromController:fromViewController orView:fromView forUser:nil withGroupId:nil];
}
...
{
    [self registerUserAndLaunchChat:nil andFromController:fromViewController orView:fromViewController.view forUser:userId withGroupId:nil];
}
...
-(void)registerUserAndLaunchChat:(ALUser *)alUser andFromController:(UIViewController *)viewController orView:(UIView*)view forUser:(NSString *)userId withGroupId:(NSNumber *)groupID
{
    ...
    if(deviceKey != nil)
    {
        ...
        else
        {
          ...
          [self.chatLauncher launchChatList2:title andView:view];
        }
        return;
    }
...
-(void)ALDefaultChatViewSettings
{
    ...
    [ALApplozicSettings setStatusBarBGColor:[UIColor colorWithRed:86.0/255 green:128.0/255 blue:179.0/255 alpha:1]];
    ...
    [ALApplozicSettings setColorForNavigation:[UIColor colorWithRed:86.0/255 green:128.0/255 blue:179.0/255 alpha:1]];
    ...
    [ALApplozicSettings setColorForSendMessages:[UIColor colorWithRed:184.0/255 green:229.0/255 blue:248.0/255 alpha:1]];
    
    [ALApplozicSettings setCustomMessageBackgroundColor:[UIColor colorWithRed:220/255 green:220/255 blue:220/255 alpha:1]];              /*  SET CUSTOM MESSAGE COLOR */
    ...
    [ALApplozicSettings setColorForTypeMsgBackground:[UIColor colorWithRed:239/255.0 green:238/255.0  blue:244/255.0 alpha:1]];     /*  SET COLOR FOR TYPE MESSAGE OUTER VIEW */
    [ALApplozicSettings setMsgTextViewBGColor:[UIColor colorWithRed:239/255.0 green:238/255.0  blue:244/255.0 alpha:1]];        /*  SET BG COLOR FOR MESSAGE TEXT VIEW */
